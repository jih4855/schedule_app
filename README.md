...
<div align="center">
  <img src="./일정관리.gif" alt="AI Schedule Manager Demo" width="100%">

  **"내일 오후 2시 회의" → 자동으로 일정 등록!**

  복잡한 폼 작성 없이 대화하듯 자연어로 일정을 관리하세요.
</div>
...
- **다중 일정 분석 및 입력**:"내일 오후 2시에 기획팀 주간 회의가 있고, 20일 저녁 7시에는 강남역에서 저녁 약속이 있어. 아, 그리고 22일 오전 10시에 스케일링 예약한 것도 잊지 말고 추가해줘."
